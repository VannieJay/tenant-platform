                ...
                <div className="absolute inset-0 h-full w-full bg-zinc-900">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center text-white p-12 max-w-lg">
                            ...
                            <h2 className="text-3xl font-bold mb-4">Modern Property Management</h2>
                            <p className="text-lg text-white/80 leading-relaxed">
                                Streamline your rental experience with our comprehensive platform for tenants and property managers.
                            </p>
                        </div>
                    </div>
                </div>
